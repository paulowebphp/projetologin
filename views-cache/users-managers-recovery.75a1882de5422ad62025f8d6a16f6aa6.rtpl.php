...
<body>
  ...
  <section id="email-canvas">
      ...
      <div class="email-row">
        ...
        <span>
          Para redefinir sua senha, clique no botão abaixo ou acesse o link: <?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>
        </span>
      ...
      <div class="email-row email-button">
        ...
        <a target="_blank" href="<?php echo htmlspecialchars( $link, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
          <span>Redefinir</span>
        </a>
      ...
      <div class="email-row">
        ...
        <div class="email-footer">
          ...
          <span>
            Precisa de ajuda? <a target="_blank" href="#"><strong>Fale conosco</a>
          </span>
