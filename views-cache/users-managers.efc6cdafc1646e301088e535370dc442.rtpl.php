<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <form action="/487733admin/administrador">
      ...
      <a class="title1 color1" href="/487733admin/administrador"><h2>Administrador</h2></a>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href='/487733admin/administrador/editar/<?php echo setHash($value1["iduser"]); ?>'>
              ...
              <td>
                <a href='/487733admin/administrador/mudar-senha/<?php echo setHash($value1["iduser"]); ?>'>
