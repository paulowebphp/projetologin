    ...
    <main role="main" class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <section>
        ...
        <div class="container">
            ...
            <form action='/487733admin/administrador/mudar-senha/<?php echo setHash($user["iduser"]); ?>' method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4>Mudar Senha de <?php echo htmlspecialchars( $user["deslogin"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h4>
                        <h5><small>(ID: <?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>)</small></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                            ...
                            <div class="mb-3">
                            <label for="current_pass" class="form-label">Insira a Senha Atual</label>
